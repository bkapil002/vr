    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <div className="w-full max-w-md bg-white rounded-lg shadow-2xl p-8 md:p-12 mb-24">
          ...
          {/* Title */}
          <h1 className="text-2xl md:text-[25px] font-medium text-center text-gray-800 mb-3">
          ...
          {/* Next Button */}
          <button className="w-full bg-[#005a9e] text-white font-medium py-3 rounded mt-6 mb-6">
            Next
          </button>
