  ...
  const cards = [
    {
      ...
      description: "Upgrade campuses with cutting-edge VR tools that make trade learning safer, faster, and more effective.",
      image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=300&fit=crop",
      alt: "Students in classroom"
    },
    {
      title: "Workforce Development Programs",
      description: "Empower your community with VR-powered skill training built for today's high-demand careers.",
      image: "https://images.unsplash.com/photo-1531482615713-2afd69097998?w=400&h=300&fit=crop",
      alt: "Workforce training session"
    },
    {
      title: "Corporations & Apprenticeships",
      description: "Enhance corporate training and apprenticeships with immersive simulations that build real-world trade skills.",
      image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=400&h=300&fit=crop",
      alt: "Corporate training"
    },
    {
      title: "Government Training Centers",
      description: "Strengthen national workforce capability with advanced VR training for Government and Military personnel.",
    ...
    <div className="  mt-20 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-20 pb-8 flex items-center justify-between  border-gray-200 pt-8">
          ...
          <a href="#"  className="flex cursor-pointer items-center gap-2 text-sm text-gray-600 hover:text-gray-900 transition-colors">
            ↑ Back to top
          </a>
        </div>
      </div>
