        ...
        {programs.map((p, index) => (
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <button className="inline-flex items-center rounded-[2px] cursor-pointer text-white bg-[#0067B8] px-8 py-2 text-sm font-semibold transition-colors duration-200 self-start">
                Explore
              </button>
            </div>
          </div>
