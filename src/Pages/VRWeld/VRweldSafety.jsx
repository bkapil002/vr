      ...
      <div className="container max-w-[1400px] mx-auto px-6 xl:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="aspect-[3/2] bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg overflow-hidden">
              <img
          ...
          <div className="space-y-6 order-1 lg:order-2">
            <h2 className="text-2xl lg:text-3xl xl:text-4xl font-semibold leading-tight text-black">
