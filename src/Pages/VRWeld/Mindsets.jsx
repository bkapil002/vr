            ...
            <div className="w-full bg-white  text-black py-9 lg:py-10">
                <div className="container max-w-[1400px] mx-auto px-6 xl:px-8">
                    ...
                    <div className="text-center mb-8 lg:mb-12">
                        {/* Title */}
                        <h2 className="text-2xl max-w-4xl lg:text-3xl xl:text-4xl mx-auto font-semibold mb-6 lg:mb-8">
                            Empowering Mindsets. Transforming Futures. Through Skill-Based VR Welding Training
                        </h2>

                        {/* Description */}
                        <p className="text-base lg:text-lg text-gray-700 max-w-3xl mx-auto mb-8 leading-relaxed">
                    ...
                    <div className="relative w-full">
                        <div className="aspect-[16/9] lg:aspect-[21/9] rounded-lg overflow-hidden">
                            <video
