...
const ShapeLearners = () => {
    ...
    const stories = [
        {
            image: gif,
            header: "Built for Scalable Technical Education",
            points: [
                "Structured learning modules for complex concepts",
                "Reduced reliance on costly physical automation labs",
                "Safe environment for beginner-to-advanced learners",
                "Consistent instruction across classes and locations",
                "Flexible integration with existing programs"
            ]
        }
    ]
        ...
        <div className='max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8'>
            <div className="bg-white text-black py-9 lg:py-10 relative overflow-hidden">
                ...
                <div className='w-full pt-8 pb-3 justify-center items-center text-center'>
                    <p className='text-base italic text-gray-700 leading-relaxed pt-2'>Teach advanced systems with clarity and confidence.</p>
                </div>
            </div>
        </div>
    )
