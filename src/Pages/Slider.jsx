              ...
              <div key={index} className="min-w-full h-full relative">
                ...
                <div className="absolute inset-0 hidden [@media(min-width:1289px)]:flex max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 items-center -mt-22">
                  <div className="max-w-[590px] text-left">
                    ...
                    <button className="bg-[#0067B8] text-sm font-semibold cursor-pointer text-white px-4 py-1.5 sm:px-6 sm:py-2 md:px-7 md:py-2.5 rounded-[2px] transition-colors duration-300 hover:bg-[#005a9e]">
                      {slide.buttonText}
                    </button>
                  </div>
                </div>
